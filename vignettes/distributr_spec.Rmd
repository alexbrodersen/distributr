...
It would be convenient to summarize the workflow in terms of the parameter grid and the function  graph. 
...
BatchJobs and BatchExperiments (ref) support a fully asynchronous workflow, and support various backends including SGE, Torque, and SSH. This is a feat. The interface is maximally flexible with many of the features described above. But it was difficult to use and remember the function names and argument structure. I also found it difficult to reason about errors when they occurred.
